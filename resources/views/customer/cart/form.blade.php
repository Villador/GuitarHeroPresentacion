...
<tr class="cartProducts">
  ...
  <td><img src="{{ $cartProduct->productpicture->count()>0 ? Storage::url($cartProduct->productpicture[0]->src) : '/imagesProducts/musicgeneric.jpg'}}" alt="" width="60px" height="60px"> </td>
